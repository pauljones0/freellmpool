# Archived 0.13 agent profiles

These historical examples describe print-only profiles and the released 0.13.0 compatibility surface, including registry-readiness hardening. They do not establish containment of every inference path. Use the [managed client setup](AGENTS.md) for the maintained gateway.
