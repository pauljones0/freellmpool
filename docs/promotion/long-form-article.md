...
The current packaged catalog has 13 cataloged providers, 128 enabled chat routes,
and 128 cataloged chat models. It can produce a first reply without any API keys
