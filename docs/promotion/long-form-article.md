...
The current packaged catalog has 15 cataloged providers, 138 enabled chat routes,
and 138 cataloged chat models. It can produce a first reply without any API keys
