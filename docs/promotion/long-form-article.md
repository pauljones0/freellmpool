...
The current packaged catalog has 14 cataloged providers, 132 enabled chat routes,
and 132 cataloged chat models. It can produce a first reply without any API keys
