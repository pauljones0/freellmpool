...
The current packaged catalog has 15 cataloged providers, 136 enabled chat routes,
and 136 cataloged chat models. It can produce a first reply without any API keys
