...
Current catalog: 14 cataloged providers, 132 enabled chat routes, and 132 cataloged chat
models.
...
14 cataloged providers, 132 enabled chat routes, keyless start when routes are available.
