...
Current catalog: 15 cataloged providers, 136 enabled chat routes, and 136 cataloged chat
models.
...
15 cataloged providers, 136 enabled chat routes, keyless start when routes are available.
